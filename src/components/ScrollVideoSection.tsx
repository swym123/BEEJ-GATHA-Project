...
// // ✅ FIXED: Import the video asset so your bundler processes its URL properly
...
//             >
//               {/* ✅ FIXED: Use the bundle-ready imported variable variable here */}
...
export default function ScrollVideoSection() {
  ...
  useEffect(() => {
    ...
    /* ── Intersection observer for .a-item reveals ── */
    const io = new IntersectionObserver(
      (entries) => {
        entries.forEach((e) => {
          if (e.isIntersecting) {
