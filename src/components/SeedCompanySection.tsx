...
// //       {/* After section */}
// //       <div id="sc-after">
// //         <h2>One Seed.<em>Infinite Potential.</em></h2>
// //         <p>
...
//       function getScattered(VW: number, VH: number, tW: number, tH: number) {
//         return [
//           { leftFrac: 0.450, topFrFrac: 0.080 },
//           { leftFrac: 0.680, topFrac: 0.180 },
//           { leftFrac: 0.460, topFrac: 0.400 },
//           { leftFrac: 0.680, topFrac: 0.530 },
//           { leftFrac: 0.460, topFrac: 0.710 },
...
//       {/* After section */}
//       <div id="sc-after">
//         <h2><span className="sc-black-text">One Seed<br></br></span><em>Infinite Potential</em></h2>
//         <p>
//           Every seed we send you has been selected, tested, trialed, and packed with
//           care — because we believe the future of farming begins with a seed you can trust.
//         </p>
...
@media (max-width: 768px) {
  ...
  .sc-m-stack {
    position: relative;
    /* Spaced out exactly to hold card flow heights with minimal lingering */
    height: calc(5 * 52vh + 10vh);
    background: var(--sc-bg);
  }

  /* Each item is sticky, offset from top below the navbar so cards fan/stack */
  .sc-m-item {
    position: -webkit-sticky;
    position: sticky;
    width: 100%;
    padding: 0 1.2rem 24px; /* Added 24px padding-bottom for beautiful gap between cards */
    box-sizing: border-box;
  }

  .sc-m-card {
    width: 100%;
    border-radius: 24px; /* Slightly rounder, premium feel */
    overflow: hidden;
    background: linear-gradient(135deg, #131b0e 0%, #0b0f07 100%); /* Elegant forest black gradient */
    border: 1px solid rgba(140, 198, 63, 0.12); /* Subtle green border */
    display: flex;
    flex-direction: column;
  }
  ...
  .sc-m-body {
    ...
    background: transparent; /* Flowing with the card's gradient */
    flex: 1;
  }
  .sc-m-tag {
    display: inline-block;
    font-size: 8px; letter-spacing: .22em; text-transform: uppercase;
    color: var(--sc-card-accent);
    background: rgba(140, 198, 63, 0.08); /* Translucent pill background */
    border: 1px solid rgba(140, 198, 63, 0.25);
    padding: 4px 10px; border-radius: 100px; /* Gorgeous modern pill shape */
    margin-bottom: .6rem;
    font-weight: 500;
  }
  .sc-m-title {
  ...
  .sc-m-progress-wrap {
    height: 3px; /* Slightly thicker, high-tech */
  ...
  .sc-m-progress-fill {
    height: 100%;
    border-radius: 100px;
    background: linear-gradient(90deg, var(--sc-card-accent) 0%, #a2db58 100%); /* Sleek green gradient */
  }
  .sc-m-counter {
    font-size: 9px; letter-spacing: .16em; text-transform: uppercase;
  ...
  /* Extra scroll space so last card sits visible before after section */
  .sc-m-tail {
    height: 8vh; /* Reduced from 40vh to close the gap completely */
  }
